...
$(document).ready(function () {
	$("#b1")
		.on('click', function () {
			...
			if (c > 3) {
				$(this)
					.attr({
						href: "     https://www.marketprod.club/?sl=5143783-82dd5&data1=Track1&data2=Track2&tag={External_ID_from_traffic_source}&website={subID}&placement={sub_subID} ",
						target: "_self"
					});
			}
		});
	$("#b2")
		.on('click', function () {
			if (c > 3) window.location = "  https://www.marketprod.club/?sl=5143783-82dd5&data1=Track1&data2=Track2&tag={External_ID_from_traffic_source}&website={subID}&placement={sub_subID} ";
