            ...
            <tbody>
                @foreach ($options as $option)
                    <tr>
                        ...
                        <td>{{ $option->oquestion->content }}</td>
                            ...
                            <div class="d-inline-flex">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="{{ route('options.edit', $option->id) }}" class="dropdown-item">
                                            <i class="ph-file-doc me-2"></i>
                                            تعديل
                                        </a>
                                        <a href="#" onclick="performDestroy({{ $option->id }},this)"
                                            class="dropdown-item">
                                            <i class="ph-file-doc me-2"></i>
                                            حذف
                                        </a>
