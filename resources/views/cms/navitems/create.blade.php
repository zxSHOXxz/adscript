                    ...
                    <div class="card-body">
                        <form action="#">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="color" id="background" class="form-control form-control-color"
                                    name="background">
                            </div>
                            <div class="d-flex justify-content-end align-items-center">
                                <a href="{{ route('navitems.index') }}" class="btn btn-light">الغاء</a>
...
@section('scripts')
    <script>
        function performStore() {
            ...
            store('/cms/admin/navitems', formData);
        }
    </script>
@endsection
